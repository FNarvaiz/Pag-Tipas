...
function sendGroupMailPrepare(byRef mailMsg, emailAddresses, subject, message)
  mailMsg.resetAll
  mailMsg.Host = "190.210.151.238"
  mailMsg.From = mainEmailAddress
  mailMsg.FromName = mainEmailName
...
function sendGroupMail(emailAddresses, occultEmailAddresses, subject, message)
  dim mailMsg
  set mailMsg = Server.CreateObject("Persits.MailSender")
  sendGroupMailPrepare mailMsg, emailAddresses, subject, message
