...
function renderFileUploadDialog
  ...
  <div id="fileUploadDialog">
    <form name="formFileUpload" encType="multipart/form-data" action="forms/utils/fileUpload.asp" method="POST" target="fileUploadFrame">
...
function renderHTMLEditorDialog
  ...
  <div id="htmlEditorDialog">
    <table class="dialog" cellpadding="0" cellspacing="0" width="100%" height="100%">
      ...
      <tr>
        <td class="dialogBody" height="510" align="center" valign="middle">
          <div id="htmlEditorDiv" style="width: 100%; height: 510px"></div>
        </td>
      </tr>
      <tr>
        <td class="dialogButtons" valign="top">
